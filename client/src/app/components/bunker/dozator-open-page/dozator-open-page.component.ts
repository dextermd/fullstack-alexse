...
export class DozatorOpenPageComponent implements OnInit {
  ...
  elements: any = [
    {one: 'BXN-50D1.3', two: 'Открыты От -10 до +45 °C От 0 до +40 °C', three: '18', four: '50', five: '0,02', six: '2,3', seven: '1075х983х 1140', eight: '128', nine: 'RS232', ten: 'Средний (III)'},
    {one: 'BXN-100D1.3', two: 'Открыты От -10 до +45 °C От 0 до +40 °C', three: '30', four: '100', five: '0,05', six: '2,3', seven: '1075х983х 1430', eight: '169', nine: 'RS232', ten: 'Средний (III)'},
    {one: 'BXN-200D1.3', two: 'Открыты От -10 до +45 °C От 0 до +40 °C', three: '60', four: '200', five: '0,1', six: '3,6', seven: '1150х1075х1390', eight: '212', nine: 'RS232', ten: 'Средний (III)'},
    {one: 'BXN-300D1.3', two: 'Открыты От -10 до +45 °C От 0 до +40 °C', three: '90', four: '300', five: '0,1', six: '5,7', seven: '1317х1206х1526', eight: '260', nine: 'RS232', ten: 'Средний (III)'},
