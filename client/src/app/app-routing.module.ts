...
export const routes: Routes = [
  {
    path: '',  component: MainLayoutComponent, children: [
      ...
      {path: 'ro/industrial-scales', redirectTo: '/ro/auto-indexContact'},
      {path: 'ro/tradescales', redirectTo: '/ro/products/subcategory/5f1e8d291c902614531f7ed4'},
      {path: 'ro/produktsiya/ro-industrialscales/itemlist/category/16-avtomobilnye-vesy', redirectTo: '/ro/auto-indexContact'},
      {path: 'ro/produktsiya/ro-industrialscales/itemlist/category/17-vagonnye-vesy', redirectTo: '/ro/wagon-indexContact'},
      ...
      {path: 'ro/produktsiya/ro-industrialscales', redirectTo: '/ro/auto-indexContact'},
      {path: 'ro/produktsiya/ro-industrialscales/itemlist/category/16-avtomobilnye-vesy', redirectTo: '/ro/auto-indexContact'},
      ...
      {path: 'ro/produktsiya/ro-industrialscales/itemlist/category/18-doziruyushchie-sistemy', redirectTo: '/ro/bunker-indexContact'},
      ...
      {path: 'ru/produktsiya/ru-industrialscales/itemlist/category/17-vagonnye-vesy', redirectTo: '/ru/wagon-indexContact'},
      ...
      {path: 'ru/produktsiya/ru-industrialscales', redirectTo: '/ru/auto-indexContact'},
      {path: 'ru/produktsiya/ru-industrialscales/itemlist/category/16-avtomobilnye-vesy', redirectTo: '/ru/auto-indexContact'},
      ...
      {path: 'ru/produktsiya/ru-industrialscales/itemlist/category/18-doziruyushchie-sistemy', redirectTo: '/ru/bunker-indexContact'},
      ...
      {path: 'en/produktsiya/en-industrialscales', redirectTo: '/en/auto-indexContact'},
      {path: 'en/produktsiya/en-industrialscales/itemlist/category/16-avtomobilnye-vesy', redirectTo: '/en/auto-indexContact'},
      ...
      {path: 'en/produktsiya/en-industrialscales/itemlist/category/17-vagonnye-vesy', redirectTo: '/en/wagon-indexContact'},
      {path: 'en/produktsiya/en-industrialscales/item/119-rail-scales', redirectTo: '/en/wagon-scales'},
      {path: 'en/produktsiya/en-industrialscales/itemlist/category/18-doziruyushchie-sistemy', redirectTo: '/en/bunker-indexContact'},
      ...
      {path: 'auto-indexContact', component: IndustrialComponent},
      ...
      {path: 'wagon-indexContact', component: VagonIndexPageComponent},
      {path: 'wagon-scales', component: VagonPageComponent},
      {path: 'wagon-modern', component: VagonModernPageComponent},
      {path: 'bunker-indexContact', component: DozatorIndexPageComponent},
